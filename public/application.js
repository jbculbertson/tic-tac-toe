...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://stormy-springs-72072.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateGame = function onCreateGame(event) {
	  ...
	  api.showGames(data).then(ui.showGamesSuccess).catch(ui.showGamesFailure);
	};
	...
	var whoseTurn = function whoseTurn(num) {
	  if (num % 2 === 0) {
	    turn = 'X';
	  } else {
	    turn = 'O';
	...
	var evaluateBoard = function evaluateBoard(array) {
